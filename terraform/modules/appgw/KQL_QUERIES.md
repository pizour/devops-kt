...
| project TimeGenerated, clientIP_s, requestUri_s, httpMethod_s, httpStatus_d, timeTaken_d, host_s, serverRouted_s
...
| project TimeGenerated, clientIp_s, requestUri_s, ruleId_s, ruleGroup_s, action_s, details_message_s
| sort by TimeGenerated desc
| take 100
```
...
| where ResourceType == "APPLICATIONGATEWAYS"
| where Category == "ApplicationGatewayFirewallLog"
| summarize HitCount = count() by ruleId_s, ruleGroup_s, action_s
...
## 5. Top 10 Client IPs by Request Count
...
| project TimeGenerated, clientIP_s, requestUri_s, httpMethod_s, httpStatus_d, serverRouted_s
| sort by TimeGenerated desc
| take 100
```
...
## 8. Backend Health (Server Response Codes)
...
## 11. Unhealthy Backend Instances
